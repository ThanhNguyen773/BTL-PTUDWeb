...
exports.createBill = async (req, res, next) => {
  try {
    ...
    if(result.acknowledged)
      return res.json({message : "Thêm Mới Đơn Sách Thành Công"})
    return res.json({message : "Thêm Mới Đơn Sách Thất Bại"})
...
exports.updateBill = async (req, res, next) => {
  try {
    ...
    if(result)
      return res.json({message : "Cập Nhật Đơn Sách Thành Công"})
